  ...
  businesses.map((business) => {
    ...
    if (business.branchOffices.length > 0) {
      ...
      business.branchOffices.map((branchOffice) => {
        ...
        // get the gross incomes that lack the declaration 
          // iterate from each months since initial period 
            // if month 


        // count how many gross incomes are pending or lacking a declaration

        // count how many gross incomes are pending to be settled 
